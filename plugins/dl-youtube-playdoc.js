...
if (!text) return conn.reply(m.chat, `💥 *ادخل اسم الفيديو الذي تبحث عنه بعد الخاصية*\n\nمثال:\n !${command} El Grande Toto - BLUE LOVE`,  m, rcanal, )
m.react(rwait)
...
> _*🍬 جاري التحميل، انتظر قليلا 🍓...*_`.trim()
...
await conn.reply(m.chat, '🌟 *حدث خطأ ما*', m, rcanal, )
}}}}
...
return conn.reply(m.chat, '🌟 *اعد من جديد*', m, rcanal, )}
...
var search = await yts.search({query, hl: 'en', gl: 'EN', ...options})
