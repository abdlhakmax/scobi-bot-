...
if (!text) return conn.reply(message.chat, '🍟 *اكتب عنوان الفيديو الذي تبحث عنه بعد الخاصية*\n\nمثال:\n - ${usedPrefix command} one piece', message, rcanal)
...
conn.reply(message.chat, '🚩 *جاري التحميل...*', message, {
